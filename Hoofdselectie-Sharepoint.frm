VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} Hoofdselectie 
   Caption         =   "Geheimhoudingsverklaring"
   ClientHeight    =   3795
   ClientLeft      =   120
   ClientTop       =   465
   ClientWidth     =   5835
   OleObjectBlob   =   "Hoofdselectie-Sharepoint.frx":0000
   StartUpPosition =   1  'CenterOwner
End
Attribute VB_Name = "Hoofdselectie"
...
'    Call UpdateBookmark("fase", fse)
    ...
    ActiveDocument.ContentTypeProperties("Document Type").Value = "Geheimhoudingsverklaring"
